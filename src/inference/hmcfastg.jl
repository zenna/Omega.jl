...
defΩ(::Type{HMCFASTGAlg}) = SimpleΩ{Vector{Int}, Tracker.TrackedArray{Float64, 1, Array{Float64,1}}}
defΩ(::HMCFASTGAlg) = SimpleΩ{Vector{Int}, Tracker.TrackedArray{Float64, 1, Array{Float64,1}}}
