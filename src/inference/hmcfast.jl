...
defΩ(::Type{HMCFASTAlg}) = SimpleΩ{ID, Tracker.TrackedArray{Float64, 1, Array{Float64,1}}}
defΩ(::HMCFASTAlg) = SimpleΩ{ID, Tracker.TrackedArray{Float64, 1, Array{Float64,1}}}
