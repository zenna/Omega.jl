...
#              LinearΩ{Vector{Int}, UnitRange{Int64}, Tracker.TrackedArray{Float64, 1, Array{Float64,1}}}]
...
# # Test them all
# istracked(::Type{LinearΩ{I, SEG, T}}) where {I, SEG, T <: Tracker.TrackedArray} = true
# istracked(ΩT) = false
