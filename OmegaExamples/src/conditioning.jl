...
histogram(randsample(posterior, 1000), bins = 1)
...
md"_The probability of breast cancer is 1% for a woman at 40 who participates in a routine screening. If a woman has breast cancer, the probability is 80% that she will have a positive mammography. If a woman does not have breast cancer, the probability is 9.6% that she will also have a positive mammography. A woman in this age group had a positive mammography in a routine screening. What is the probability that she actually has breast cancer?_"
...
md"Gigerenzer and Hoffrage (1995) showed that this kind of judgment can be made much more intuitive to untrained reasoners if the relevant probabilities are presented as “natural frequencies”, or the sizes of subsets of relevant possible outcomes:"
...
md"_1% of women at age 40 who participate in a routine screening will have breast cancer. Of those with breast cancer, 80% will receive a positive mammogram. 20% of women at age 40 who participate in a routine screening will have a benign cyst. Of those with a benign cyst, 50% will receive a positive mammogram due to unusually dense tissue of the cyst. All others will receive a negative mammogram. Suppose that a woman in this age group has a positive mammography in a routine screening. What is the probability that she actually has breast cancer?_"
...
histogram(randsample(breast_cancer_cond_, 1000), bins = 1)
...
begin
    ...
    TB_ = (@~ Bernoulli(0.005)) |ₚ (worksInHospital &ₚ @~ Bernoulli(0.01))
    cold_ = (@~ Bernoulli(0.2)) |ₚ (worksInHospital &ₚ @~ Bernoulli(0.25))
end
...
histogram(randsample(lung_cancer_cond_, 1000), bins = 1)

# ╔═╡ 960755a2-138d-45a0-a0d7-872208e36023
histogram(randsample(TB_cond_, 1000), bins = 1)
