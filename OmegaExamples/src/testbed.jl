...
# ╔═╡ c47bb6f6-b965-11ec-0b19-95e158c24c5c
using Pkg

# ╔═╡ 85a1f030-fffc-4a54-b003-0c241d2ff3c5
using Random

# ╔═╡ fc4ba537-470a-47dc-a700-74d65c02671e
using Memoize

# ╔═╡ 017925c5-1498-495f-8851-edaf4f2a3773
using Omega

# ╔═╡ d8a80e1d-017b-481e-8ef8-9854042553d6
Pkg.activate(Base.current_project())

# ╔═╡ bfc26ff9-1510-4208-b18a-841f9285cb0f
Pkg.instantiate()

# ╔═╡ bc30a94e-7a88-4090-b383-5b8387b1b547
...
[[deps.Callbacks]]
deps = ["Lens", "ProgressMeter", "UnicodePlots"]
git-tree-sha1 = "22fc345f00cd8e13c0e12bdc2695553eda882d44"
uuid = "db1e321a-d383-57b4-a664-0144fd54e973"
version = "0.1.0"
...
[[deps.Lens]]
deps = ["Cassette", "Spec", "Test"]
git-tree-sha1 = "4d1f4bcefdbb4f2a8a2302098676b2047f9cc0f0"
uuid = "496038af-b016-571c-b31e-8262695ac102"
version = "0.1.1"
...
[[deps.Omega]]
deps = ["Callbacks", "Cassette", "DataStructures", "Distributions", "DocStringExtensions", "DynamicHMC", "Flux", "ForwardDiff", "Lens", "LinearAlgebra", "LogDensityProblems", "NLopt", "ProgressMeter", "Random", "Spec", "Statistics", "TransformVariables", "UnicodePlots", "Zygote"]
git-tree-sha1 = "97a0e913fbc19d4754fa0bfbdb310d1fbc36c33d"
