...
weight(i, ω) = (i ~ StdUniform{Float64}())(ω)

# ╔═╡ b050357f-596c-40d5-9bb2-83b87a95b268
function agent_belief(i, ω)
	w = (i ~ weight)(ω)
	a =  ((@uid, i...)~ Bernoulli(w)) |ᶜ ((ω -> (i ~ Binomial(4, w))(ω)) ==ₚ 4)
	a(ω)
end
